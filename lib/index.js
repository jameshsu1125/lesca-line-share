  ...
  return E || (E = 1, function(M) {
    ...
    (function(G, b) {
      G(function() {
        ...
        var t = Object.prototype.hasOwnProperty, H;
        e.FALLBACK_PHONE = "UnknownPhone", e.FALLBACK_TABLET = "UnknownTablet", e.FALLBACK_MOBILE = "UnknownMobile", H = "isArray" in Array ? Array.isArray : function(T) {
          return Object.prototype.toString.call(T) === "[object Array]";
        };
        function s(T, S) {
          return T != null && S != null && T.toLowerCase() === S.toLowerCase();
        }
        function C(T, S) {
          var i, o, P = T.length;
          if (!P || !S)
            return !1;
          for (i = S.toLowerCase(), o = 0; o < P; ++o)
            if (i === T[o].toLowerCase())
              return !0;
          return !1;
        }
        function l(T) {
          for (var S in T)
            t.call(T, S) && (T[S] = new RegExp(T[S], "i"));
        }
        function I(T) {
          return (T || "").substr(0, 500);
        }
        (function() {
          var S, i, o, P, A, r, a = e.mobileDetectRules;
          for (S in a.props)
            if (t.call(a.props, S)) {
              for (i = a.props[S], H(i) || (i = [i]), A = i.length, P = 0; P < A; ++P)
                o = i[P], r = o.indexOf("[VER]"), r >= 0 && (o = o.substring(0, r) + "([\\w._\\+]+)" + o.substring(r + 5)), i[P] = new RegExp(o, "i");
              a.props[S] = i;
            }
          l(a.oss), l(a.phones), l(a.tablets), l(a.uas), l(a.utils), a.oss0 = {
            WindowsPhoneOS: a.oss.WindowsPhoneOS,
            WindowsMobileOS: a.oss.WindowsMobileOS
          };
        })(), e.findMatch = function(T, S) {
          for (var i in T)
            if (t.call(T, i) && T[i].test(S))
              return i;
          return null;
        }, e.findMatches = function(T, S) {
          var i = [];
          for (var o in T)
            t.call(T, o) && T[o].test(S) && i.push(o);
          return i;
        }, e.getVersionStr = function(T, S) {
          var i = e.mobileDetectRules.props, o, P, A, r;
          if (t.call(i, T)) {
            for (o = i[T], A = o.length, P = 0; P < A; ++P)
              if (r = o[P].exec(S), r !== null)
                return r[1];
          }
          return null;
          ...
          var S;
          return S = T.split(/[a-z._ \/\-]/i), S.length === 1 && (T = S[0]), S.length > 1 && (T = S[0] + ".", S.shift(), T += S.join("")), Number(T);
          ...
          if (T.mobile === b) {
            var o, P, A;
            if (P = e.findMatch(e.mobileDetectRules.tablets, S), P) {
              T.mobile = T.tablet = P, T.phone = null;
              return;
            }
            if (o = e.findMatch(e.mobileDetectRules.phones, S), o) {
              T.mobile = T.phone = o, T.tablet = null;
              return;
            }
            e.isMobileFallback(S) ? (A = n.isPhoneSized(i), A === b ? (T.mobile = e.FALLBACK_MOBILE, T.tablet = T.phone = null) : A ? (T.mobile = T.phone = e.FALLBACK_PHONE, T.tablet = null) : (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null)) : e.isTabletFallback(S) ? (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null) : T.mobile = T.tablet = T.phone = null;
          }
          ...
          return (
            ...
            T.version("Chrome") >= 11 && !S || // Safari Desktop 4-5 - Tested on OS X 10.7 and Windows 7
            T.version("Safari") >= 5 && !S || // Firefox Desktop 4-13 - Tested on OS X 10.7 and Windows 7
            T.version("Firefox") >= 4 && !S || // Internet Explorer 7-9 - Tested on Windows XP, Vista and 7
            T.version("MSIE") >= 7 && !S || // Opera Desktop 10-12 - Tested on OS X 10.7 and Windows 7
            // @reference: http://my.opera.com/community/openweb/idopera/
            T.version("Opera") >= 10 && !S ? "A" : T.os("iOS") && T.version("iPad") < 4.3 || T.os("iOS") && T.version("iPhone") < 3.1 || T.os("iOS") && T.version("iPod") < 3.1 || // Blackberry 5.0: Tested on the Storm 2 9550, Bold 9770
            ...
            T.version("Opera Mobi") >= 11 && T.is("SymbianOS") ? "B" : (
              // Blackberry 4.x - Tested on the Curve 8330
              (T.version("BlackBerry") < 5 || // Windows Mobile - Tested on the HTC Leo (WinMo 5.2)
              T.match("MSIEMobile|Windows CE.*Mobile") || T.version("Windows Mobile") <= 5.2, "C")
            )
          );
        ...
        function n(T, S) {
          this.ua = I(T), this._cache = {}, this.maxPhoneWidth = S || 600;
        }
        return n.prototype = {
          constructor: n,
          /**
           ...
           */
          userAgents: function() {
            return this._cache.userAgents === b && (this._cache.userAgents = e.findMatches(e.mobileDetectRules.uas, this.ua)), this._cache.userAgents;
          },
          /**
           ...
           */
          is: function(T) {
            return C(this.userAgents(), T) || s(T, this.os()) || s(T, this.phone()) || s(T, this.tablet()) || C(e.findMatches(e.mobileDetectRules.utils, this.ua), T);
          },
          /**
        ...
        }, typeof window < "u" && window.screen ? n.isPhoneSized = function(T) {
          return T < 0 ? b : e.getDeviceSmallerSide() <= T;
        } : n.isPhoneSized = function() {
        }, n._impl = e, n.version = "1.4.5 2021-03-13", n;
      });
    })(function(G) {
      if (M.exports)
        return function(b) {
...
var u = D();
const V = /* @__PURE__ */ d(u), c = () => {
  const M = new V(window.navigator.userAgent);
  return M.tablet() || M.mobile() ? "mobile" : "desktop";
}, N = (M, G) => {
  c() === "mobile" ? window.open(`line://msg/text/${encodeURIComponent(G + `
` + M)}`, "_blank") : window.open(
    `https://lineit.line.me/share/ui?url=${encodeURIComponent(M)}&text=${encodeURIComponent(
      G
    )}`
  );
}, L = { share: N };
